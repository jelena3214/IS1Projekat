...
public class Subsystem2 {
    ...
    static Queue s2Queue;

    
    public static void main(String[] args) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("javaEEsub2PU");
        ...
        try {
            ...
            System.out.println("Subsystem2 started");
            while(true){
                System.out.println("Subsystem2 waiting...");
